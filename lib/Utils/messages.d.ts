...
import type { AnyMediaMessageContent, AnyMessageContent, MessageContentGenerationOptions, MessageGenerationOptions, MessageGenerationOptionsFromContent, MessageUserReceipt, NativeFlowButton, WAMessage, WAMessageContent, WAMessageKey } from '../Types/index.js';
...
export declare const getContentType: (content: proto.IMessage | null | undefined) => keyof proto.IMessage | undefined;
/**
 ...
 * Accepts shorthand buttons ({ id }, { copy }, { url }, { call }, { sections })
 * plus optional offerText/optionText extras.
 */
export declare const prepareNativeFlowButtons: (message: {
...
export declare const hasValidInteractiveHeader: (message: proto.IMessage) => boolean;
/** media types that are valid at the top of a carousel card */
export declare const hasValidCarouselHeader: (message: proto.IMessage) => boolean;
/**
...
export declare const hasOptionalProperty: (obj: object | null | undefined, key: string) => boolean;
