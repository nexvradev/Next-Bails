...
// local alias so generics.js can fall back to the same constant it re-exports
import { WA_WEB_VERSION_FALLBACK } from './wa-version.js';
// The WA Web version now lives in ./wa-version.js — it is monotonic and never
// downgrades on reconnect (see WhiskeySockets/Baileys#2777).
export {
	...
	normalizeWaVersion,
	pickNewestWaVersion,
	rememberWaWebVersion,
	resetCachedWaWebVersion,
	resolveWaWebVersion
} from './wa-version.js';
...
export const fetchLatestBaileysVersion = async (options = {}) => {
    ...
    try {
        ...
        return {
            version: WA_WEB_VERSION_FALLBACK,
            isLatest: false,
            error
        };
    }
