...
type EncryptedStreamOptions = {
    ...
    logger?: ILogger;
    opts?: RequestInit;
    /** reuse an existing 32-byte media key instead of generating a fresh one (e.g. sticker pack thumbnail sharing the pack key) */
    mediaKey?: Buffer | Uint8Array;
};
export declare const encryptedStream: (media: WAMediaUpload, mediaType: MediaType, { logger, saveOriginalFileIfRequired, opts, mediaKey }?: EncryptedStreamOptions) => Promise<{
