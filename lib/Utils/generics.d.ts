...
/**
 * `fetchLatestWaWebVersion` now lives in ./wa-version.js (re-exported from here)
 * and is monotonic: it never downgrades to the packaged version once a newer
 * one has been seen — see WhiskeySockets/Baileys#2777.
 */
export { fetchLatestWaWebVersion, resolveWaWebVersion, compareWaVersions, normalizeWaVersion, pickNewestWaVersion, isWaVersionNewer, getCachedWaWebVersion, rememberWaWebVersion, resetCachedWaWebVersion, WA_WEB_VERSION_FALLBACK } from './wa-version.js';
export type { FetchWaWebVersionOptions, FetchWaWebVersionResult, ResolveWaWebVersionOptions, ResolveWaWebVersionResult } from './wa-version.js';
